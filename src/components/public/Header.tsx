    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-background border-b-4 border-steel-slate">
      <div className="flex justify-between items-center w-full px-gutter h-20 max-w-container-max mx-auto">
        ...
        <div className="hidden md:flex items-center gap-stack-lg">
          <a
            href="#pricing"
            className="font-mono text-xs uppercase text-on-background hover:bg-surface-variant hover:text-safety-orange transition-colors px-2 py-1"
          >
            Pricing
          </a>
          <a
        ...
        <div className="flex items-center gap-stack-sm">
          <a
            href="#contact"
            className="hidden sm:block bg-safety-orange text-lathe-charcoal font-mono text-xs uppercase px-stack-lg py-stack-md border-2 border-lathe-charcoal hover:bg-machine-white transition-all active:translate-y-1"
          >
            START CUT
          </a>
          <button
            onClick={() => setMenuOpen(!menuOpen)}
            className="md:hidden text-machine-white p-2"
      ...
      {menuOpen && (
        <div className="md:hidden bg-background border-t-2 border-steel-slate px-gutter pb-stack-md">
          <a
            href="#pricing"
            className="block py-stack-sm font-mono text-xs uppercase text-on-background"
