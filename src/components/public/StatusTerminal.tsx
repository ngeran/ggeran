...
export default function StatusTerminal({
  ...
  return (
    <>
      <section id="specifications" className="bg-surface-container-low border-y-4 border-steel-slate">
        <div className="max-w-container-max mx-auto px-gutter py-margin">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 border-2 border-steel-slate divide-y-2 md:divide-y-0 md:divide-x-2 divide-steel-slate">
            {features.map((spec) => (
              <div key={spec.id} className="p-stack-lg group hover:bg-lathe-charcoal transition-colors">
                <div className="flex justify-between items-start mb-stack-lg">
                  <span className="font-mono text-xs text-safety-orange">{spec.specNumber}</span>
          ...
          <div className="space-y-stack-lg">
            <div className="border-b-2 border-steel-slate pb-stack-md">
              ...
              <p className="font-mono text-lg text-machine-white leading-tight uppercase">
                {techHeading || "The groove is the data. The lathe is the encoder."}
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-stack-md">
              {technical.map((spec) => (
                <div key={spec.id} className="border-2 border-steel-slate p-stack-md bg-surface-container hover:border-safety-orange transition-colors">
